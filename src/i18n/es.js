export const es = {
  ...
  trainedLesson: {
    ...
    playTraining: "Reproducir entrenamiento",
    stopTraining: "Detener",
    ...
    previewingSplit: (condition) => `Probando división: ${condition}`,
    selectedBestSplit: (condition) => `Mejor división seleccionada: ${condition}`,
